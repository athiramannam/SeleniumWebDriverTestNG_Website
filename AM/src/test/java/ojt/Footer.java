...
WebDriver driver;
	...
	public void openSite() throws InterruptedException {
			...
			WebElement resLink = driver.findElement(By.xpath("(//a[@href='contact.html'][normalize-space()='Contact'])[1]"));
			Thread.sleep(2000);
			resLink.click();
			Thread.sleep(5000);
...
//		servicesLink.click();
		...
		String expectedUrl ="https://gspedia.com/projects/aviationmedicals2/contact.html";
...
//		servicesLink.click();
		...
		String expectedTitle ="Contact || Aviation Medicals";
