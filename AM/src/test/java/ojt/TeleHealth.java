...
WebDriver driver;
	...
	public void openSite() throws InterruptedException {
			...
			WebElement resLink = driver.findElement(By.xpath("(//a[@href='tele-health.html'][normalize-space()='Tele-health'])[1]"));
			Thread.sleep(2000);
			resLink.click();
			Thread.sleep(5000);
...
//		servicesLink.click();
		...
		String expectedUrl ="https://gspedia.com/projects/aviationmedicals2/tele-health.html";
...
//		servicesLink.click();
		...
		String expectedTitle ="Telehealth || Aviation Medicals";
